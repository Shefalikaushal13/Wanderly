  ...
  return (
    <SectionWrapper id={'generate'} header={"Generate your workout"} title={['It\'s', 'Fitness', 'o\'clock']}>
      ...
      <div className='bg-slate-950 border border-solid border-blue-400 rounded-lg flex flex-col'>
        <button onClick={toggleModal} className='relative p-3 px-4 flex items-center justify-center'>
      ...
      <Header index={'03'} title={'Final Destination'} description={"Select your ultimate objective."} />
